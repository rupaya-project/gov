    ...
    <div class="container">
        <b-card class="rupaya-card">
            ...
            <div class="container">
                ...
                <h5>1. Risks related to the use of RupayaGov </h5>
                <p>
                    RupayaGov will not be responsible for any losses, damages or claims arising from
                ...
                <p>
                    (2) Software problems of RupayaGov and/or any cryptocurrency-related software
                ...
                <p>
                    The users of RupayaGov are solely responsible to determinate what, if any, taxes apply
                    to their crypto-currency transactions. The owners of, or contributors to, RupayaGov are NOT
                ...
                <h5>5. Arbitration</h5>
                <p>
                    The user of RupayaGov agrees to arbitrate any dispute arising from or in connection with
